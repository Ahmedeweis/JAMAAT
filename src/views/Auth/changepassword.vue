<template>
  ...
  <div class="text-center mt-4 mb-8 w-full">
          ...
          <label class="text-purple-800 mb-1">كلمة المرور الحالية </label>
      ...
      <button  class="w-[300px] cursor-pointer bg-[#E3614E] text-white p-3 rounded-4xl mt-6 hover:bg-red-600 transition duration-200">
        إرسال
      </button>
</div>
    </div>
